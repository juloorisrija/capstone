  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      <div class="well" style="background-image: linear-gradient(rgba(4,9,30,0.7),rgba(4,9,30,0.7)),url(https://img.freepik.com/free-vector/gradient-network-connection-background_23-2148865393.jpg?size=626&ext=jpg);">
        <h4 style="color:white;font-weight:bolder;">Compliance List</h4>
      </div>
		...
		<tr>
			...
			<c:forEach items="${complianceList}" var="comp">
				<tr>
				    ...
				    <td>${comp.getStatus1()}</td>
                    <td>${comp.getUserId()}</td>
                    <td>
									<!-- <a href="update/${comp.getDetails()}/${comp.getDate1()}/${comp.getDepartId()}/${comp.getEmplcount()}/${comp.getStatus1()}/${comp.getUserId()}">Update</a>&nbsp;-->
