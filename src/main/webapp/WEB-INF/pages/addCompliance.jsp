  ...
  <div class="row content">
    ...
    <div class="col-sm-9">
      <div class="well" style="background-image: linear-gradient(rgba(4,9,30,0.7),rgba(4,9,30,0.7)),url(https://img.freepik.com/free-vector/gradient-network-connection-background_23-2148865393.jpg?size=626&ext=jpg);">
        <h4 style="color:white;font-weight:bolder;">Add Compliance List</h4>
      </div>
	<form action="add" method="post" align="center">
		<!--  <input type="text" name="complianceId" placeholder="Enter comp ID"/><br><br>-->
		Details <br><input type="text" name="details" placeholder="Enter details"/><br>
		Date<br> <input type="text" name="date1" placeholder="Enter date"/><br> 
		DepartmentId<br> <input type="text" name="departId" placeholder="Enter departid"/><br>
		EmployeeCount<br> <input type="number" name="emplcount"/><br>
		Status<br> <input type="text" name="status1" placeholder="Enter status"/><br> 
